    ...
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            if (ADMINNUMBER.Text == "1")
            {
                ...
                ALog.Enter = Fun.ChangeToEnglishNumber(Fun.CLOCK());
            }
            else
            {
                BLog.AdminName = ADMINNAME.Text;
                BLog.Enter = Fun.ChangeToEnglishNumber(Fun.CLOCK());
            }
        ...
        private void MainForm_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (ADMINNUMBER.Text == "1")
            {
                ALog.Leave = Fun.ChangeToEnglishNumber(Fun.CLOCK());
                blc.ALoginfor(ALog);
            }
            else
            {
                BLog.Leave = Fun.ChangeToEnglishNumber(Fun.CLOCK());
                blc.BLoginfor(BLog);
            }
        }
    }
