    ...
    public partial class AccountsPanel : UserControl
    {
        ...
        private void ویرایشToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (sws)
            {
                ...
                familytxt.Text = DGV1.CurrentRow.Cells[3].Value.ToString();
                phonetxt.Text = ConvertArabicNumberToEnglish.toEnglishNumber(DGV1.CurrentRow.Cells[4].Value.ToString());
                emailtxt.Text = DGV1.CurrentRow.Cells[5].Value.ToString();
                addresstxt.Text = DGV1.CurrentRow.Cells[6].Value.ToString();
                username.Text = DGV1.CurrentRow.Cells[7].Value.ToString();
                userpass.Text = DGV1.CurrentRow.Cells[8].Value.ToString();
                accesscode.Text = DGV1.CurrentRow.Cells[9].Value.ToString();
                SW = false; //  ویرایش
